# apps/lead_dedupe/lead_dedupe/api/crm_lead_archive.py

import frappe
from lead_dedupe.leads.dup_utils import norm_mobile, recompute_hit_counts   # same helper you use elsewhere
