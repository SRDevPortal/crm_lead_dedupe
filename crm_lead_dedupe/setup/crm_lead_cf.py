...
CUSTOM_FIELDS = [
    ...
    {
        "fieldname": "sr_dedupe_result",
        "label": "Dedupe Result",
        "fieldtype": "Select",
        "options": "\nPrimary\nDuplicate\nSkipped",
        "insert_after": "sr_dedupe_stage",
        "in_list_view": 1,
        "in_standard_filter": 1,
        "read_only": 1,
    },
    {
        "fieldname": "sr_dedupe_pipeline",
        "label": "Pipeline at Dedupe",
        "fieldtype": "Data",
        "insert_after": "sr_dedupe_result",
        "in_list_view": 1,
        "in_standard_filter": 1,
        "read_only": 1,
    },
    {
        "fieldname": "sr_dedupe_queued_at",
        "label": "Dedupe Queued At",
        "fieldtype": "Datetime",
        "insert_after": "sr_dedupe_pipeline",
        "read_only": 1,
    },
    {
        "fieldname": "sr_dedupe_not_before",
        "label": "Dedupe Not Before",
        "fieldtype": "Datetime",
        "insert_after": "sr_dedupe_queued_at",
        "read_only": 1,
    },
    {
        "fieldname": "sr_dedupe_started_at",
        "label": "Dedupe Started At",
        "fieldtype": "Datetime",
        "insert_after": "sr_dedupe_not_before",
        "read_only": 1,
    },
    {
        "fieldname": "sr_dedupe_completed_at",
        "label": "Dedupe Completed At",
        "fieldtype": "Datetime",
        "insert_after": "sr_dedupe_started_at",
        "read_only": 1,
    },
    {
        "fieldname": "sr_dedupe_input_hash",
        "label": "Dedupe Input Hash",
        "fieldtype": "Data",
        "insert_after": "sr_dedupe_completed_at",
        "hidden": 1,
        "read_only": 1,
    },
    {
        ...
        "fieldtype": "Check",
        "default": "0",
        "insert_after": "sr_dedupe_input_hash",
        "hidden": 1,
        "read_only": 1,
    },
    {
...
def ensure_indexes():
    ...
    for fields, index_name in (
        ...
        (["sr_dedupe_pending", "sr_dedupe_stage", "sr_dedupe_not_before"], "idx_crmlead_dedupe_due"),
